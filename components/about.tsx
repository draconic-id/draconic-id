        ...
        {!isFormVisible && !aboutText ? (
          ...
          <EditorContent
            ...
            className="prose-sm max-w-none
              ...
              [&>div>blockquote]:border-l-4 [&>div>blockquote]:text-muted-foreground [&>div>blockquote]:border-muted-foreground [&>div>blockquote]:pl-4 [&>div>blockquote]:italic [&>div>blockquote]:mb-4
