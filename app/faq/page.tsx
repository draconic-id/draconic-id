      ...
      <div className="flex flex-col items-center max-w-4xl mx-auto px-6">
        <div className="w-full">
          <div className="space-y-4">
            <QA question="Who is Draconic ID intended for?">
            ...
            <QA question="How did Draconic ID come to be?">
            ...
            <QA question="Who is behind Draconic ID?">
            ...
            <QA question="What am I allowed to put on my profile?">
            ...
            <QA question="I am afraid of exposing my location on the map.">
            ...
            <QA question="My map marker is getting covered up by others.">
            ...
            <QA question="Will my profile show up on Google (and other search engines)?">
            ...
            <QA question="Is information on my profile used for AI (artificial intelligence)?">
            ...
            <QA question="What are your privacy policy and terms of use like?">
            ...
            <QA question="Will Draconic ID still be around in the far future?">
              ...
              <ul className="list-disc text-lg list-inside space-y-3 ml-4">
                ...
                <li>The website is <Link href="https://github.com/draconic-id/draconic-id" className="underline" target="_blank">open-source</Link>. In the future, you will be able to clone the code to host your own instance. Together with the API data and public archives, this can be used by anyone to pick up the torch if the original website ever were to go down.</li>
            ...
            <QA question="I have feedback, a question, a concern or want to report a bug.">
              <p className="text-lg leading-relaxed">Feel free to reach out by sending us an <Link href="https://mailhide.io/e/RPzCeWBk" className="underline" target="_blank">e-mail</Link>. We promise we won't bite! We respond the same day on a best-effort basis. It should take a few days at most. Feature requests can also be made by e-mailing us.</p>
            </QA>
          </div>
        </div>
      </div>
