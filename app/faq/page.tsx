        ...
        <div className="w-full">
          ...
          <div className="space-y-8">
            ...
            <div id="who-is-behind-draconic-id" className="scroll-mt-16">
              ...
              <p className="text-lg leading-relaxed">Yours truly, Bluefire. You can visit my <Link href="/profile/PkKltWOmS3dhUhUR" className="underline">Draconic ID profile</Link> or <Link href="https://bluefi.re" className="underline">website</Link> to learn more about me. I'm also actually in the site's logo, lovingly made by <Link href="/profile/d9VFY0DwvdI_nuHi" className="underline">Ven</Link>.</p>
            </div>
            ...
            <div id="what-am-i-allowed-to-put" className="scroll-mt-16">
              ...
              <p className="text-lg leading-relaxed">Anything! As long as it does not cause harm to anyone and is appropriate for all ages. This extends to your profile's metadata such as your name, tagline and profile picture as well. We also ask of you to keep the content on your profile relevant, instead of placing random text or spam here. A full outline of what you are allowed to put on your profile can be found in the terms of use. If you found a profile containing inappropriate content, feel free to contact us.</p>
            </div>
            ...
            <div id="profile-used-for-ai" className="scroll-mt-16">
              ...
              <p className="text-lg leading-relaxed">We do not use data you have entered on your profile for the purpose of training or enhancing AI. We also employ technologies such as <Link href="https://developers.cloudflare.com/bots/additional-configurations/block-ai-bots" className="underline">AI bot blocking through Cloudflare</Link> to limit the information third-party AI providers such as OpenAI, Google and Microsoft can retrieve.</p>
            </div>
            ...
            <div id="future-availability" className="scroll-mt-16">
              ...
              <ul className="list-disc list-inside space-y-3 ml-4">
                <li>We periodically create full back-ups which are stored on-site with redundancy and in the cloud so that we can restore the site if data loss ever were to occur. We use encryption to make sure third-parties are not able to read any of this data.</li>
                <li>We make as much data as possible freely accessible through APIs. This means that anyone can easily export, back-up and use profiles. We use standard formats such as JSON and HTML so your information is never locked to our platform.</li>
                ...
                <li>The Internet Archive is a non-profit digital library that has been crucial to the archival of the history of dragon websites and communities. We periodically supply them a list of all public profiles on Draconic ID so that they can create complete archives of all public profiles at different points in time. These archives are publicly accessible through the <Link href="https://web.archive.org" className="underline">Wayback Machine</Link> by supplying the URL.</li>
              </ul>
            </div>
            ...
            <div id="feedback-contact" className="scroll-mt-16">
              ...
              <p className="text-lg leading-relaxed">Feel free to reach out by sending us an <Link href="https://mailhide.io/e/RPzCeWBk" className="underline">e-mail</Link>. We promise we won't bite! We respond the same day on a best-effort basis, though it should take a few days at most.</p>
            </div>
          </div>
        </div>
      </div>
